...
const settingTabs = computed(() => [
  ...
  {
    label: t("setting.tabWebSearch"),
    value: "n_search",
    icon: "icon-wangluosousuo",
    contentComponent: WebSearchPane,
  },
  {
  ...
  {
    label: t("setting.tabTranslation"),
    value: "translation",
    icon: "icon-fanyi",
  ...
  },
  {
    ...
    contentComponent: ProxyPane,
  },
  { label: t("setting.tabData"), value: "data", icon: "icon-shuju", contentComponent: DataPane },
  {
    label: t("setting.tabPortal"),
    value: "portal",
    icon: "icon-chuansongmen",
    contentComponent: PortalPane,
  },
  {
    label: t("setting.tabAbout"),
    value: "about",
    icon: "icon-guanyu1",
    contentComponent: AboutPane,
  },
]);
